...
\vspace {1cm}
The mesh method consists of assigning a current to each elementary mesh and then solving the Kirchhoffs Voltage Law (KVL) for each of them. The equations used are the following:
